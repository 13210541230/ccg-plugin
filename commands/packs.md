...
```bash
python "$CLAUDE_PLUGIN_ROOT/scripts/ccg_pack_manager.py" --packs-root "~/.claude/.ccg/packs" list
```
...
```bash
python "$CLAUDE_PLUGIN_ROOT/scripts/ccg_pack_manager.py" --packs-root "~/.claude/.ccg/packs" $ARGUMENTS
```
